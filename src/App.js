                  ...
                  return (
                    <div>
                      {!e.isDeleted &&  // checking if the element is deleted or not
                        <TodoCard key={e.id} title={e.title} id={e.id} complete={completeHandler} updateColor={UpdateColor} color={e.color} isCompleted={e.isCompleted} delete={deleteHandler} />}
                    </div>
                  )
                } else {
                  return <></>
          ...
          <div className='card-list'>
            {
              toDos?.map((e) => {
                if (e.isCompleted) {
                  return (!e.isDeleted && <TodoCard key={e.id} id={e.id} title={e.title} isCompleted={e.isCompleted} delete={deleteHandler} updateColor={UpdateColor} color={e.color} />)
                } else {
                  return <></>
                }
              })
